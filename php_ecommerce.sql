...
INSERT INTO `payment_modes`(`name`) VALUES ('Cash on Delivery'),('Over the Counter'),('PayPal');
INSERT INTO `statuses`(`name`) VALUES ('Pending'),('Processing'),('Done'),('Rejected');
INSERT INTO `categories` (`name`) VALUES ('Trees'), ('Flowers'), ('Herbs'),('Succulent'),('Vegetable');
